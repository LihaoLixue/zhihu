...
img1 = Image.open('e:\\Desert.jpg')
img_w1, img_h1 = img1.size
img1 = numpy.asarray(img1, dtype='float32') / 256.
img1_rgb = img1.swapaxes(0,2).swapaxes(1,2).reshape(1,3,img_w1, img_h1)

img2 = Image.open('e:\\Desert.jpg')
...
img2_rgb = img2.swapaxes(0, 2).swapaxes(1, 2).reshape(1, 3, img_w2, img_h2)  # (3,height,width)
